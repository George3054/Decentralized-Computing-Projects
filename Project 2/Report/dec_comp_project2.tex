...
\begin{document}
	...
	\center{ \textbf{Αλγόριθμος 1,σελ 13(διαφάνειες)} } \gr
	
	
	
	\begin{figure}[htbp!]
		\centering
		\subfloat[\centering \en Random Example]{{\includegraphics[scale=0.4]{netlogo_images/alg1_baselinks.png} }}%
		\quad
		%\subfloat[\centering \en 3n links(n=10)]{{\includegraphics[scale=0.4]{img/mockups/signup_screen.png} }}%
		
	%	\subfloat[\centering \en 7n links(n=10)]{{\includegraphics[scale=0.4]{img/mockups/user/user\_menu.png}}}%
	\end{figure}
